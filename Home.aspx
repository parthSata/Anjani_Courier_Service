...
<body>
    <nav class="navbar navbar-expand-lg sticky-top bg-dark-subtle">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Anjani Courier Service</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <asp:HyperLink runat="server" ID="HyperLink3" NavigateUrl="~/TrackStatus.aspx" CssClass="nav-link" Text="Courier Update" />
                    </li>

                </ul>
                <form class="d-flex justify-content-between" role="search" runat="server">
                    <div>
                        <asp:Button ID="Button2" class="btn btn-outline-primary" runat="server" Text="Login" OnClick="Button2_Click" />
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center">
                ...
                <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center">
                    <img class="img-fluid rounded-3 my-5" src="https://www.pngitem.com/pimgs/m/170-1702369_delivery-management-system-logo-hd-png-download.png" alt="..." />
                </div>
            </div>
        </div>
    </header>
