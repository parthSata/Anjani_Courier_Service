                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-outline ">
                                            ...
                                            <label class="form-label" for="form3Example1q">Weight (In kg ) :</label>
                                            <asp:TextBox class="form-control form-control-lg" ID="text_weight" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" placeholder="Enter Weight" runat="server" OnTextChanged="text_weight_TextChanged"></asp:TextBox>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="text_weight" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+"></asp:RegularExpressionValidator><br />

                                            <label class="form-label" for="form3Example1q">Charges :</label>
                                            <asp:TextBox class="form-control form-control-lg" ID="text_charges" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" placeholder="Enter Charges" runat="server" OnTextChanged="text_charges_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="text_charges" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+"> </asp:RegularExpressionValidator><br />
                                            ...
                                            <asp:DropDownList ID="From_Destination" class="form-control form-control-lg" runat="server">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <asp:TextBox class="form-control form-control-lg" type="date" DataFormatString="{0:dd/MM/yyyy}" ID="text_date" runat="server"></asp:TextBox>
